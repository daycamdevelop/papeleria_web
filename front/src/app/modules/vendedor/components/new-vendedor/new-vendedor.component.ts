...
@Component({
  selector: 'app-new-vendedor',
  templateUrl: './new-vendedor.component.html',
  styleUrls: ['./new-vendedor.component.css']
})
export class NewVendedorComponent implements OnInit {
